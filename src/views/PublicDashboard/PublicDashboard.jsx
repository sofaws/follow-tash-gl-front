            ...
            <Card>
              <CardHeader color="danger">
                ...
                <p className={classes.cardCategoryWhite}>
                  Si tu es dans cette liste alors impute vite tes temps, avant
                  que Jérémy te trouve ! :O
                </p>
              </CardHeader>
              <CardBody>
                ...
                <div style={{ display: "flex", flexDirection: "row", margin: '10px', flexWrap: 'wrap' }}>
                  {usersNotImputed.map(user => (
                    <div key={user.member.id} style={{ margin: '25px', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
                      <Avatar
